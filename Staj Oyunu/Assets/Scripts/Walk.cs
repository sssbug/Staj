        ...
        private void CharacterQuery()
        {
            if (gameManager.characters.Contains(this.gameObject))
            {
                ...
                else
                {
                    ...
                    {
                        transform.position = Vector3.MoveTowards(transform.position, gameManager.characters[_characterCount - 1].transform.position + new Vector3(-350, 0, 0), speed * Time.deltaTime);
